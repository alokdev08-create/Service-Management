...
public class ServiceProviderController {
	...
	public ResponseEntity<ServiceProvider> createServiceProviderDetails(@RequestBody ServiceProvider serviceProvider) {
	  ...
	  @GetMapping("/fetchAllServiceProviderDetails")
	    public ResponseEntity<List<ServiceProvider>> fetchAllServiceProvider() {
	        List<ServiceProvider> serviceProvider = serviceProviderService.fetchAllServiceProviderDetails();
